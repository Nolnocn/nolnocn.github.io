...
site.portfolioContent = {
    ...
    animaker: {
        ...
        desc: "<i>The Animaker</i> is a simple animation tool that allows the user to create frame-based animations by adding, arranging, and moving images around in a canvas.<br><br>It was created as part of an intro to web development course I took as a way to explore HTML5 technologies. In particular, we used the Canvas API for rendering the animation and the Drag & Drop API for uploading images. While it’s certainly not as robust or feature-rich as a fully fledged animation tool, it was a great learning project. I recall the animation timeline with thumbnails for each frame being a tough nut to crack, and when I look back on projects like this, I am genuinely impressed with my past self."
    },
    ...
    doodle: {
        ...
        desc: "As part of the first animation course I took in college, we designed a 'game' and created assets for said game. We did not actually develop the games, but rather focused on asset production intended for use in a game. Projects included the creation of typical game animations such as an idle pose, walk cycle, jump, and some sort of action. The final project tasked us with storyboarding and creating an intro cinematic for our game idea.<br><br>My game was <i>Doodle Defender</i>, a side-scrolling platformer starring the eponymous Doodle Defender as he tries to wrangle rogue doodles terrorizing the notebook. Check out some of the animations I created and more about the project <a href=\"https://blargh.nconlon.com/2024/03/doodle-defender.html\" target=\"_blank\">over on the blog</a>.",
    },
